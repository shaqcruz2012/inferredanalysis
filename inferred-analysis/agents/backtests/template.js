...
/**
 * Wrapper preserving the original (prices, signals) call signature.
 * The `prices` arg is unused (kept for backward compatibility with agents
 * that call `runBacktest(prices, signals)`).
 */
